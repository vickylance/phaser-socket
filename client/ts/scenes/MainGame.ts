...
class MainGame extends Phaser.Scene {
  constructor() {
    ...
    GS.sendMessage('init', { initState: 'joined' });
  }
  ...
  public preload() {
    ...
    GS.sendMessage('init', { initState: 'loaded' });
  }
  ...
  public create() {
    ...
    GS.sendMessage('init', { initState: 'ingame' });
  ...
  public update() {
    ...
    if (this.input.activePointer.isDown) {
      ...
      GS.sendMessage('player', { player: { pos: { x: this.player.x }} });
    }
  ...
  private gameOver() {
    ...
    GS.sendMessage('player', { state: 'dead' });
